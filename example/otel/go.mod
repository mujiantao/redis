module github.com/mujiantao/redis/example/otel

go 1.14

replace github.com/mujiantao/redis/v8 => ../..

replace github.com/mujiantao/redis/extra/redisotel/v8 => ../../extra/redisotel

replace github.com/mujiantao/redis/extra/rediscmd/v8 => ../../extra/rediscmd

require (
	github.com/mujiantao/redis/extra/redisotel/v8 v8.11.5
